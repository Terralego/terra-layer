    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_settings', django.contrib.postgres.fields.jsonb.JSONField(default={})),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_fields', models.ManyToManyField(through='terra_layer.FilterField', to='django_geosource.Field')),
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_geosource.Source')),
                ('table_export_fields', models.ManyToManyField(related_name='in_layers_export', to='django_geosource.Field')),
                ('table_fields', models.ManyToManyField(related_name='in_layers', to='django_geosource.Field')),
            ],
        ),
        migrations.AddField(
            model_name='filterfield',
            name='layer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='terra_layer.Layer'),
        ),
    ]
